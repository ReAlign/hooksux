(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rax')) :
  typeof define === 'function' && define.amd ? define(['exports', 'rax'], factory) :
  (factory((global['hooksux-rax'] = {}),global.rax));
}(this, (function (exports,rax) {
  var _ = {
  ...
  function builder$1 (name, reducer, initState) {
    var r = {
      createElement: rax.createElement,
      createContext: rax.createContext,
      useReducer: rax.useReducer
    };
  ...
  var ProvidersComposer = function (props) {
    ...
    var createElement = r.createElement;
    return props.providers.reduceRight(function (children, Parent) { return createElement( Parent, null, children ); }, props.children);
  };

  var createProvider = function (r, providers) { return function (props) {
    var createElement = r.createElement;
    return createElement( ProvidersComposer, { r: r, providers: providers },
        props.children
      );
  }; };
